...
import numpy as np
from model.diffusion_util import TransformerModel, TransformerEncoder
...
class Encoder(nn.Module):
    def __init__(self, *, ch, ch_mult=(1,2,4), num_res_blocks,
                 ...
                 z_channels, double_z=False, **ignore_kwargs):
        super().__init__()
        self.ch = ch
        self.temb_ch = 0
        ...
        self.out_transencoder = TransformerEncoder(pose_dim=z_channels)
